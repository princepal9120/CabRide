...
<h3 align="center">Full Stack rider Clone</h3>
...
handling payments, serverless Postgres for managing databases, and styled with TailwindCSS, rider Clone is a perfect
...
```bash
git clone https://github.com/JavaScript-Mastery-Pro/rider.git
cd rider
```
...
EXPO_PUBLIC_SERVER_URL=https://rider.dev/
